...
def fill_missing():
    path = "Currency_Conversion_Test_Data"
...
st.markdown("<h1 style='text-align: left; color: #041058;'><u>Currency exchange rate DASHBOARD by Hammad Javaid</u></h1>", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: left; color: #041058;'><u>Data feed from 2013-2022</u></h1>", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: black; background: #D296CA'><i>~i21-1661~</i></h1>", unsafe_allow_html=True)
 
df = pd.read_csv("Currency_Conversion_Test_Data/Exchange_Rate_Report_2012.csv")
...
currency = pd.read_csv("Currency_Conversion_Test_Data/Exchange_Rate_Report_2021.csv")
...
path = "Currency_Conversion_Test_Data/Exchange_Rate_Report_{}.csv".format(year)
df = pd.read_csv(path)
...
def get_yearly_data(option):
    ...
    for i in range(len(years)):
        path = "Currency_Conversion_Test_Data/Exchange_Rate_Report_{}.csv".format(years[i])
        df = pd.read_csv(path)
